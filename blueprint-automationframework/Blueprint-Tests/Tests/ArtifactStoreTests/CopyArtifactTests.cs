...
namespace ArtifactStoreTests
{
    ...
    public class CopyArtifactTests : TestBase
    {
        ...
        */
        ...
        public void MoveArtifact_PublishedArtifact_CopyToParentArtifactWithInvalidToken_401Unauthorized(BaseArtifactType artifactType)
        {
            // Setup:
            ...
            {
                ArtifactStore.CopyArtifact(Helper.ArtifactStore.Address, sourceArtifact, _project.Id, userWithBadToken);
