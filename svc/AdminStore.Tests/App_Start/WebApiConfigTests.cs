...
namespace AdminStore
{
    ...
    public class WebApiConfigTests
    {
        ...
        public void Register_Always_RegistersCorrectRoutes()
        {
            ...
            // Assert
            config.AssertTotalRoutes(84, "Please update asserts in WebApiConfigTests when changing routes.");
            ...
            config.AssertAction<MetadataController>("GetIconsAsnyc", HttpMethod.Get, "icons?type=artifact&typeId=128&imageId=123");
        }
