...
{
    public class BlueprintSqlDatabaseSink : IObserver<EventEntry>, IDisposable
    {
        ...
        /// <summary>
        /// Finalizes an instance of the <see cref="BlueprintSqlDatabaseSink"/> class.
        /// </summary>
        ~BlueprintSqlDatabaseSink()
        {
            Dispose(false);
        }
        ...
        /// <summary>
        /// Releases all resources used by the current instance of the <see cref="BlueprintSqlDatabaseSink"/> class.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
