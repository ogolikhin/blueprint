...
module Storyteller {
    ...
    export class SystemDecision extends UserTaskChildElement<IProcessShape> implements IDecision, IUserTaskChildElement {
        ...
        public showMenu(graph: ProcessGraph) {
            this.addOverlay(graph, this, "/Areas/Web/Style/images/Storyteller/add-neutral.svg", this.MENU_SIZE, this.MENU_SIZE, "Add Branch", mxConstants.ALIGN_CENTER, mxConstants.ALIGN_BOTTOM, 0, 7, "hand");
        ...
        public render(graph: ProcessGraph, x: number, y: number, justCreated: boolean): IDiagramNode {
            ...
            this.insertVertex(graph, this.model.id.toString(), null, x, y, this.SYSTEM_DECISION_WIDTH, this.SYSTEM_DECISION_HEIGHT, "shape=rhombus;strokeColor=" + this.DEFAULT_BORDER_COLOR + ";fillColor=" + fillColor + ";fontColor=#4C4C4C;fontFamily=Open Sans, sans-serif;fontStyle=1;fontSize=12;foldable=0;");
            ...
            this.detailsButton.render(graph, this, this.SYSTEM_DECISION_WIDTH / 2 - this.BUTTON_SIZE / 2, this.SYSTEM_DECISION_HEIGHT - this.BUTTON_SIZE - 10, "shape=ellipse;strokeColor=none;fillColor=none;selectable=0");
            
            // DO NOT DELETE!!! this is needed for the labels functionality
            var overlay = this.addOverlay(graph, this.detailsButton, null, this.SYSTEM_DECISION_WIDTH, this.SYSTEM_DECISION_HEIGHT, null, mxConstants.ALIGN_LEFT, mxConstants.ALIGN_TOP, this.SYSTEM_DECISION_WIDTH / 2, this.SYSTEM_DECISION_HEIGHT / 2);
        ...
        public getFirstSystemTask(graph: ProcessGraph): ISystemTask {
            var targets = this.getTargets(graph);
            if (targets) {
         ...
         * @param graph
         */
        public getSystemNodes(graph: ProcessGraph): IDiagramNode[] {
            return this.getTargets(graph);
        }
