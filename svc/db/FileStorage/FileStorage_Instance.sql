...
USE [AdminController]
GO
/****** Object:  StoredProcedure [dbo].[FileStorageMaintenanceJob]    Script Date: 3/14/2017 12:05:16 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
DECLARE @databaseName nvarchar(128) = CONCAT(@instance, N'_FileStorage');
DECLARE @jobName nvarchar(128) = CONCAT(@instance, N'_FileStorage_Maintenance');
...
DECLARE @cmd nvarchar(max) = N'[' + @databaseName + N'].[FileStore].DeleteExpiredFiles';
...
/******      Schedule the job       ******/
DECLARE @scheduleName nvarchar(128) = CONCAT(@instance, N'_FileStorage_Maintenance_Schedule');
