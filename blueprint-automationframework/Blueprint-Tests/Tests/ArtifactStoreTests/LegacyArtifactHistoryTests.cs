...
namespace ArtifactStoreTests
{
    ...
    public class LegacyArtifactHistoryTests : TestBase
    {
        ...
        public void GetDiagramArtifact_PublishAndGetDiagamArtifact_ReturnsLatestVersionOfDiagramArtifact()
        {
            // Setup: Create and publish a diagram artifact
            var publishedDiagramArtifact = Helper.CreateAndPublishArtifact(_project, _user, BaseArtifactType.GenericDiagram);
        ...
        public void GetGlossaryArtifact_PublishAndGetGlossaryArtifact_ReturnsLatestVersionOfGlossaryArtifact()
        {
            ...
            // Execute: Get the diagram artifact using GetGlossaryArtifact
            Assert.DoesNotThrow(() => {
        ...
        public void GetDiagramArtifact_PublishAndGetDiagramArtifactWithoutSpecificVersion_ReturnsLatestVersionOfDiagramArtifact(int numberOfVersions)
        {
            // Setup: Create and publish a diagram artifact multiple times to have multiple versions of it
            var publishedDiagramArtifact = Helper.CreateAndPublishOpenApiArtifact(_project, _user, BaseArtifactType.GenericDiagram, numberOfVersions: numberOfVersions);
        ...
        public void GetUseCaseArtifact_PublishAndGetUseCaseArtifactWithoutSpecificVersion_ReturnsLatestVersionOfUseCaseArtifact(int numberOfVersions)
        {
            ...
            // Execute: Get the diagram artifact using GetUseCaseArtifact without passing versionId parameter
            Assert.DoesNotThrow(() => {
                usecaseArtifact = Helper.ArtifactStore.GetUseCaseArtifact(_user, publishedUseCaseArtifact.Id);
            }, "'GET {0}' should return 200 OK when passed a valid artifact ID!", RestPaths.Svc.ArtifactStore.USECASE_id_);
        ...
        public void GetDiagramArtifact_PublishAndGetDiagramArtifactWithVersion1_ReturnsFirstVersionOfDiagramArtifact()
        {
            // Setup: Create and publish a diagram artifact two times to have two versions of it			
            IArtifact publishedDiagramArtifact = Helper.CreateAndPublishArtifact(_project, _user, BaseArtifactType.GenericDiagram);
        ...
        public void GetDiagramArtifact_PublishAndGetDiagamArtifactWithInvalidTokenHeader_401Unauthorized(string token)
        {
            // Setup: Create and publish a diagram artifact
            var publishedDiagramArtifact = Helper.CreateAndPublishArtifact(_project, _user, BaseArtifactType.GenericDiagram);
            NovaDiagramArtifact diagramArtifact = null;
        ...
        public void GetDiagramArtifact_PublishAndGetDiagamArtifactWithInvalidVersionId_404NotFound(int versionId)
        {
            // Setup: Create and publish a diagram artifact
            var publishedDiagramArtifact = Helper.CreateAndPublishArtifact(_project, _user, BaseArtifactType.GenericDiagram);
            NovaDiagramArtifact diagramArtifact = null;
