...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('App_UP_Relationships_Selected', 'en-US', N'item(s) selected')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Confirmation_Delete_Trace', 'en-US', N'Are you sure you want to permanently delete the selected trace?')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Confirmation_Delete_Traces', 'en-US', N'Are you sure you want to permanently delete the selected traces?')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('App_Save_Artifact_Error_409_123', 'en-US', N'The artifact cannot be saved. It inherits from an actor that already inherits from this artifact. Actor artifacts cannot inherit from themselves.')
