/* /// <reference path="../../../../Scripts/typings/bowser/bowser.d.ts" /> */
...
module ExecutionEnvironment {
    ...
    export class ExecutionEnvironmentDetector implements IExecutionEnvironmentDetectorService {
        ...
        /*
        public setCookie(hours: number) {
            const d = new Date(new Date().getTime() + 1000 * 3600 * hours);
            document.cookie = "browserupdate=pause; expires=" + d.toUTCString() + "; path=/";
        }

        public getCookie(): boolean {
            return (document.cookie.indexOf("browserupdate=pause") > -1);
        }
        */
    }
}
