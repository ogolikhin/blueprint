module Storyteller {
    /***
     * GraphLayoutPreprocessor 
     * This class contains functions that use graph traversal 
     * algorithms to calculate the logical x,y coordinates for
     * each shape and link in the graph. The rendering engine
     * uses these coordinates to visually layout the graph.
     */
    export interface IGraphLayoutPreprocessor {
        setCoordinates();
    }

    export class GraphLayoutPreprocessor {
        ...
        constructor(
            private model: IProcessClientModel,
