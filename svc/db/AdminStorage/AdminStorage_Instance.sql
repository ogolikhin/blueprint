...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Publish_All_Dialog_Message', 'en-US', N'You have unpublished changes to {0} artifact(s).<br/>After publishing, all changes made to each artifact will be available to other users. Please review and confirm:')
