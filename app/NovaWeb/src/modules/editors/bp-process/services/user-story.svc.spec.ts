...
describe("userStoryService", () => {
    ...
    // describe("getUserStoryId", () => {
    //     it("returns number by provided taskId",
    //         inject(($httpBackend: ng.IHttpBackendService, userStoryService: IUserStoryService) => {
    //             // arrange
    //             let projectId = 1;
    //             let processId = 2;
    //             let userStories: IUserStory[] = <any>[{ id: 1, processTaskId: 11 }, { id: 2, processTaskId: 22 }];
    ...
    //             // act
    //             const userStoryId = userStoryService.getUserStoryId(11);

    //             // assert
    //             expect(userStoryId).toBe(1);
    //         })
    //     );

    //     it("returns null if user stories were not generated yet",
    //         inject(($httpBackend: ng.IHttpBackendService, userStoryService: IUserStoryService) => {
    //             // act
    //             const userStoryId = userStoryService.getUserStoryId(11);

    //             // assert
    //             expect(userStoryId).toBeNull();
    //         })
    //     );

    //     it("returns null if user task is not found among generated user stories",
    //         inject(($httpBackend: ng.IHttpBackendService, userStoryService: IUserStoryService) => {
    //             // arrange
    //             let projectId = 1;
    //             let processId = 2;
    ...
    //             // act
    //             const userStoryId = userStoryService.getUserStoryId(23);
