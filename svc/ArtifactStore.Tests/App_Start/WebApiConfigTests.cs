...
namespace ArtifactStore
{
    ...
    public class WebApiConfigTests
    {
        ...
        public void Register_Always_RegistersCorrectRoutes()
        {
            ...
            // Assert
            config.AssertTotalRoutes(38, "Please update asserts in WebApiConfigTests when changing routes.");
            ...
            config.AssertAction<ReviewContainersController>("ReviewArtifactsRemovalParams", HttpMethod.Post, "containers/1/artifacts/remove");
        }
