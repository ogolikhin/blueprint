...
$(function(){
  ...
  var AppView = Backbone.View.extend({
    ...
    render: function() {
	  ...
	  if (Todos.surveyTitle.length) {
		this.titleSection.show();
		this.titleSection.html(this.titleTemplate({surveyTitle: Todos.surveyTitle}));
	  }
    ...
    setTitle: function(e) {
      ...
      //Todos.create();
	  Todos.surveyTitle = this.title.val();
      this.title.val('');
    },
