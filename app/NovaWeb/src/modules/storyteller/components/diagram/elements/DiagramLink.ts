module Storyteller {
    export class DiagramLink extends DiagramElement implements IDiagramElement, IMenuContainer {
        ...
        public initializeLabel(graph: ProcessGraph, sourceNode: IDiagramNode, targetNode: IDiagramNode) {
        ...
        public showMenu(graph: ProcessGraph) {
            ...
            var overlay = new ConnectorOverlay(new mxImage("/Areas/Web/Style/images/Storyteller/add-neutral.svg", 16, 16), "Add Task/Decision");
