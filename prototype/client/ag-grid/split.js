...
(function() {
  ...
  var global = this
    ...
    var startDragging = function (e) {
      ...
      this.a.style[dimension] = calc + '(' + (offset / this.size * this.percentage) + '% - ' + (pairs.length > 2 ? this.aGutterSize + (options.gutterSize / 2) : this.aGutterSize ) + 'px)'
      this.b.style[dimension] = calc + '(' + (this.percentage - (offset / this.size * this.percentage)) + '% - ' + (pairs.length > 2 ? this.bGutterSize + (options.gutterSize / 2) : this.bGutterSize) + 'px)'
    }
      , fitMin = function () {
      var self = this
        , a = self.a
