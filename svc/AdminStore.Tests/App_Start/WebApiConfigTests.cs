...
namespace AdminStore
{
    ...
    public class WebApiConfigTests
    {
        ...
        public void Register_Always_RegistersCorrectRoutes()
        {
            ...
            // Assert
            config.AssertTotalRoutes(62, "Please update asserts in WebApiConfigTests when changing routes.");
            ...
            config.AssertAction<InstanceController>("GetProjectGroupsAsync", HttpMethod.Get, "instance/groups/1/available");
        }
