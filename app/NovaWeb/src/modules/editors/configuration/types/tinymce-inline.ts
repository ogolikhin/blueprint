...
export class BPFieldTinymceInline implements AngularFormly.ITypeOptions {
    public name: string = "bpFieldInlineTinymce";
    public template: string = require("./tinymce-inline.template.html");
    public wrapper: string = "bpFieldLabel";
    public defaultOptions: AngularFormly.IFieldConfigurationObject;
    public controller: Function = BpFieldTinymceInlineController;
...
export class BpFieldTinymceInlineController {
