...
namespace AdminStoreTests
{
    ...
    public class JobsTests : TestBase
    {
            ...
            )
        {
            ...
            AdminStoreHelper.JobResultValidation<OpenAPIJob>(jobResult: jobResult, pageSize: pageSize);
            ...
            )
        {
            ...
            AdminStoreHelper.JobResultValidation<AddJobResult>(jobResult: jobResult, pageSize: pageSize);
        }
