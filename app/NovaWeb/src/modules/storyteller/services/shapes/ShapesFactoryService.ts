module Storyteller {
    ...
    class ShapesFactoryServiceSettings {
    ...
    export class ShapesFactoryService {

        private _idGenerator = new IdGeneratorService();
        ...
        private settings = new ShapesFactoryServiceSettings();
        ...
        public  createPropertyValuesForUserTaskShape(persona: string = this.NEW_USER_TASK_PERSONA,
            ...
            propertyValues[this.ClientType.key] = this.createClientTypeValue(BluePrintSys.RC.CrossCutting.ProcessShapeType.UserTask);
        ...
        public  createPropertyValuesForSystemTaskShape(persona: string = this.NEW_SYSTEM_TASK_PERSONA,
            ...
            propertyValues[this.Width.key] = this.createWidhtValue(width);
            propertyValues[this.Height.key] = this.createHeightValue(height);
            propertyValues[this.ClientType.key] = this.createClientTypeValue(BluePrintSys.RC.CrossCutting.ProcessShapeType.SystemTask);
            propertyValues[this.Objective.key] = this.createObjectiveValue(objective);  
            propertyValues[this.Include.key] = this.createIncludeValue(include);
        ...
        public  createPropertyValuesForUserDecisionShape(label: string = this.NEW_USER_DECISION_LABEL,
            ...
            propertyValues[this.Width.key] = this.createWidhtValue(width);
            propertyValues[this.Height.key] = this.createHeightValue(height);
            propertyValues[this.ClientType.key] = this.createClientTypeValue(BluePrintSys.RC.CrossCutting.ProcessShapeType.UserDecision);
            propertyValues[this.Objective.key] = this.createObjectiveValue(objective);
        ...
        public  createPropertyValuesForSystemDecisionShape(label: string = this.NEW_SYSTEM_DECISION_LABEL,
            ...
            propertyValues[this.Width.key] = this.createWidhtValue(width);
            propertyValues[this.Height.key] = this.createHeightValue(height);
            propertyValues[this.ClientType.key] = this.createClientTypeValue(BluePrintSys.RC.CrossCutting.ProcessShapeType.SystemDecision);
            propertyValues[this.Objective.key] = this.createObjectiveValue(objective);
        ...
        public  createLabelValue(label: string): IPropertyValueInformation {
            return {
                ...
                typePredefined: BluePrintSys.RC.CrossCutting.PropertyTypePredefined.Label,
                typeId: -1,
                value: label
            };
        }
        ...
        public  createDescriptionValue(description: string): IPropertyValueInformation {
            return {
                ...
                typePredefined: BluePrintSys.RC.CrossCutting.PropertyTypePredefined.Description,
                typeId: -1,
                value: description
            };
        }
        ...
        public  createXValue(x: number): IPropertyValueInformation {
            return {
                ...
                typePredefined: BluePrintSys.RC.CrossCutting.PropertyTypePredefined.X,
                typeId: -1,
                value: x
            };
        }
        ...
        public  createYValue(y: number): IPropertyValueInformation {
            return {
                ...
                typePredefined: BluePrintSys.RC.CrossCutting.PropertyTypePredefined.Y,
                typeId: -1,
                value: y
            };
        }
        ...
        public  createWidhtValue(width: number): IPropertyValueInformation {
            return {
                ...
                typePredefined: BluePrintSys.RC.CrossCutting.PropertyTypePredefined.Width,
                typeId: -1,
                value: width
            };
        }
        ...
        public  createHeightValue(height: number): IPropertyValueInformation {
            return {
                ...
                typePredefined: BluePrintSys.RC.CrossCutting.PropertyTypePredefined.Height,
                typeId: -1,
                value: height
            };
        }

        public  createClientTypeValue(clientType: BluePrintSys.RC.CrossCutting.ProcessShapeType): IPropertyValueInformation {
            return {
                propertyName: this.ClientType.name,
                typePredefined: BluePrintSys.RC.CrossCutting.PropertyTypePredefined.ClientType,
                typeId: -1,
                value: clientType
            };
        }

        public  createClientTypeValueForProcess(clientType: BluePrintSys.RC.CrossCutting.ProcessType) {
            return {
                propertyName: this.ClientType.name,
                typePredefined: BluePrintSys.RC.CrossCutting.PropertyTypePredefined.ClientType,
                typeId: -1,
        ...
        public  createObjectiveValue(objective: string): IPropertyValueInformation {
            return {
                ...
                typePredefined: BluePrintSys.RC.CrossCutting.PropertyTypePredefined.ItemLabel,
                typeId: -1,
                value: objective
            };
        }
        ...
        public  createAssociatedImageUrlValue(url: string = ""): IPropertyValueInformation {
            return {
                ...
                typePredefined: BluePrintSys.RC.CrossCutting.PropertyTypePredefined.None,
                typeId: -1,
                value: url
            };
        }
    ...
    app.service("shapesFactoryService", ShapesFactoryService);
}