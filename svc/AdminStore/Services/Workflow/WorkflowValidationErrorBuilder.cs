...
namespace AdminStore.Services.Workflow
{
    public class WorkflowValidationErrorBuilder : IWorkflowValidationErrorBuilder
    {
        ...
        private const string TemplateXmlPropertyChangeActionDuplicatePropertiesOnEvent = "An Event (Transition, New Artifact) has more than on Property Change Actions for the same Property. Please ensure that any Event has only one Property Change Action for a Property.";
