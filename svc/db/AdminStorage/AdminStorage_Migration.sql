...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('ST_Delete_CannotDelete_UD_AtleastTwoConditions', 'en-US', N'The task cannot be deleted. The preceding choice would be left with one condition. Choices require at least two conditions.')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('ST_Confirm_Delete_System_Decision', 'en-US', N'Please confirm the deletion of the selected condition. All conditions will also be deleted except for the first one.')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('ST_Confirm_Delete_User_Decision', 'en-US', N'Please confirm the deletion of the selected choice. All conditions will also be deleted except for the first one.')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Search_Validation_MaxTwoFiftyChars', 'en-US', N'At most 250 characters.')
