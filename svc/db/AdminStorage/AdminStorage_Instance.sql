...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('App_GeneralError', 'en-US', N'An error occurred while loading the page.<br/>Please try again.<br/><br/>If the problem persists, contact your Blueprint administrator.')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('App_Save_Artifact_Error_409_135', 'en-US', N'The baseline could not be saved. Its timestamp must be after the project creation date and earlier than the present time.')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('SubArtifact_Not_Found', 'en-US', N'The subartifact {0} could not be found.')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Artifact_Baseline_Artifacts', 'en-US', N'Artifacts')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Artifact_Baseline_Permissions_Warning', 'en-US', N'You do not have permission to view all artifacts. The items count you see represents your limited view, not the complete set of included contents.')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Artifact_Baseline_No_Artifacts_In_Baseline', 'en-US', N'There are no artifacts in this Baseline')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Artifact_Baseline_Live_Tooltip', 'en-US', N'Use the most recent artifact versions')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Artifact_Baseline_Timestamp_Tooltip', 'en-US', N'Use the artifacts as they appeared on a specific date in the past')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Artifact_Baseline_Use_12hour_Format', 'en-US', N'Please use the ''h:mm am/pm'' format.')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Artifact_Baseline_Use_24hour_Format', 'en-US', N'Please use the ''HH:mm'' format.')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Artifact_Baseline_Date_Format', 'en-US', N'Please use the ''{0}'' format.')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Artifact_Collection_Add_Artifacts_Success', 'en-US', N'Artifacts have been successfully added to the Collection ({0}).')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Artifact_Collection_Add_Artifacts_Already_Included', 'en-US', N'Artifacts have not been added to the Collection because they have already been included ({0}).')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Artifact_Container_Add_Artifacts', 'en-US', N'Add Artifacts')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Login_ForgotPassword', 'en-US', N'Forgot my password')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('PasswordRecovery_NewPassword', 'en-US', N'New Password')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('PasswordRecovery_ConfirmPassword', 'en-US', N'Confirm New Password')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('PasswordRecovery_Error_RecoveryFailed', 'en-US', N'You are not allowed to request password change.<br/>Please contact your system administrator')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('PasswordRecovery_Error_ResetFailed', 'en-US', N'The reset password request has failed.<br/>Please contact you system administrator.')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('PasswordRecovery_Error_InvalidPassword', 'en-US', N'The reset password request has failed.<br/>Please contact your system administrator.')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('PasswordRecovery_Error_RequestFailed', 'en-US', N'The request has failed.<br/>Please contact your system administrator.')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Label_UserName', 'en-US', N'User Name')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Error_Page_Message1', 'en-US', N'An error occurred while loading the page.')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Process_Walkthrough_Mode_Tooltip', 'en-US', N'Walkthrough')
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Process_Diagram_Mode_Tooltip', 'en-US', N'Process Editor')
