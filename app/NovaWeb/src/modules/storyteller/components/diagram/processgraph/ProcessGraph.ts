module Storyteller {
    ...
    export class ProcessGraph implements IProcessGraph {
        ...
        constructor(
            ...
            public viewModel: IStorytellerViewModel,
            private shapesFactoryService: ShapesFactoryService,
            private messageService: Shell.IMessageService = null,
            ...
            this.layout = new Layout(this, viewModel, rootScope, this.shapesFactoryService, this.messageService, this.$log);
                ...
                for (var j: number = 0; j < edges.length; j++) {
                    ...
                    if (edge && edge.target) {
                        ...
                        if (sourceNode
                            ...
                            if (value) {
                                (<DiagramLink>edge).showMenu(this);
                            } else {
                                (<DiagramLink>edge).hideMenu(this);
                            }
                        }
                    }
                }
                for (var i: number = 0; i < cells.length; i++) {
                    ...
                    if (cell.getNodeType) {
                        ...
                        if (cell.getNodeType() === NodeType.SystemDecision &&
                            ...
                            if (value) {
                                (<SystemDecision>cell).showMenu(this);
                            } else {
                                (<SystemDecision>cell).hideMenu(this);
                            }
                        }
                    }
                }
        ...
        public getValidMergeNodes(condition: IProcessLink): IDiagramNode[] {
            ...
            for (let shape of this.viewModel.shapes) {
                ...
                let clientType = shape.propertyValues[this.shapesFactoryService.ClientType.key].value;
