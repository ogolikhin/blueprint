module Storyteller {
    export class SubArtifactEditorModalController extends BaseModalDialogController<SubArtifactDialogModel> {
        ...
        constructor($scope: IModalScope,
            ...
            const getProcesses = () => processesPromise || (processesPromise = processModelService.getProcesses(processModelService.processModel.projectId));
        ...
        public setNextNode(processModelService: IProcessModelService)  {
            this.dialogModel.nextNode = processModelService.getNextNode(this.dialogModel.clonedSystemTask.model);
        }
