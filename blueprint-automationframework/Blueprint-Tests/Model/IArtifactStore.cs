...
namespace Model
{
    ...
    public interface IArtifactStore : IDisposable
    {
        ...
        IFile AddImage(IUser user, IFile imageFile, List<HttpStatusCode> expectedStatusCodes = null);
        ...
        IFile GetImage(string imageId, List<HttpStatusCode> expectedStatusCodes = null);
