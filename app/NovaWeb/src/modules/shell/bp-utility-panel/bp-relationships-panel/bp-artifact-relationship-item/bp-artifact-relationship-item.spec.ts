...
describe("BPArtifactRelationshipItem", () => {
    ...
    it("limitChars, replace Image tag with [Image] text if string less then 100 chars", () => {
        //Arrange
        const expectedResult = `test  [Image] `;

        //Act
        let result = vm.limitChars("test <img src=\"test.jpg\"/>");
    ...
    it("limitChars, replace Image tag with [Image] text if string more then 100 chars", () => {
        ...
        const limitCharsString = "test fffasdasfaffffffffrrffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff12345678911111"
            + "<img src=\"test.jpg\"/>";
        //Act
        let result = vm.limitChars(limitCharsString);
    ...
    it("limitChars, replace Image tag with [Image] text if string more then 100 chars and image in range of the between 0 and 100 chars", () => {
        ...
        const limitCharsString = "test fffasdasfaffffffffrr" +
            "<img src=\"test.jpg\"/>ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff12345678911111"
            + "<img src=\"test.jpg\"/>";
        //Act
        let result = vm.limitChars(limitCharsString);
