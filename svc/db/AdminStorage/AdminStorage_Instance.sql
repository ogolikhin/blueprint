...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Publish_All_Dialog_Message', 'en-US', N'You have unpublished changes to {0} artifacts.<br/>After publishing, all changes made to each artifact will be available to other users. Please review and confirm:')
...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Search_Results_SubartifactMessage', 'en-US', N'Opening this search result displays the artifact that contains it.')
