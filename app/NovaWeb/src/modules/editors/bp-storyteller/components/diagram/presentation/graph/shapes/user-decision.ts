...
import {IDiagramNodeElement, IDecision} from "../process-graph-interfaces";
...
export class UserDecision extends DiagramNode<IProcessShape> implements IDecision {
    ...
    public showMenu(mxGraph: MxGraph) {
        ...
        this.addOverlay(mxGraph, this, "/Areas/Web/Style/images/Storyteller/add-neutral.svg", 16, 16, "Add Task/Decision", mxConstants.ALIGN_CENTER, mxConstants.ALIGN_BOTTOM, 0, 7, "hand");
    }
