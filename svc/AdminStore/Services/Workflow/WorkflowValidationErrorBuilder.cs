...
namespace AdminStore.Services.Workflow
{
    public class WorkflowValidationErrorBuilder : IWorkflowValidationErrorBuilder
    {
        ...
        private const string TemplateDataEmailNotificationActionPropertyTypeNotAssociated = "The property '{0}' of an <EmailNotificationAction> element is not associated with any Artifact Types defined in the Workflow.";
        ...
        private const string TemplateDataPropertyChangeActionPropertyTypeNotAssociated = "The property '{0}' of a <PropertyChangeAction> element is not associated with any Artifact Types defined in the Workflow.";
