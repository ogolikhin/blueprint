...
namespace AdminStore.Services.Workflow.Validation
{
    public class WorkflowValidationErrorBuilder : IWorkflowValidationErrorBuilder
    {
        ...
        private const string TemplateXmlWebhookActionUrlNotSpecified = "One or more webhook actions have no URL provided. Please make sure that all <WebhookAction> elements have a <Url> child element with a value.";
        ...
        private const string TemplateXmlWebhookActionHttpHeaderInvalid = "One or more webhook actions have an invalid HTTP header provided. Please make sure that all <Header> elements within webhook actions provide HTTP headers in 'key:value' format.";
        private const string TemplateXmlWebhookActionBasicAuthInvalid = "One or more webhook actions have an invalid basic authentication provided. Please make sure that all webhook actions that provide basic authentication have a username and password specified as values for <Username> and <Password> elements.";
        private const string TemplateXmlWebhookActionSignatureSecretTokenEmpty = "One or more webhook actions have an invalid signature. Please make sure that all webhook actions that provide a signature have a <SecretToken> element with a value.";
        private const string TemplateXmlWebhookActionSignatureAlgorithmInvalid = "One or more webhook actions have an invalid signature. Please make sure that all webhook actions that provide a signature have a valid algorithm provided in the <Algorithm> element. Valid options are 'HMACSHA1' and 'HMACSHA256'. If an algorithm is not specified, 'HMACSHA256' will be used by default.";
        ...
        private const string TemplateDataPropertyNotAssociated = "<PropertyChange> elements: One or more property-change events refers to the property '{0}', which is not associated with any artifact types defined in the Workflow. Please ensure the property is correct, or the correct Artifact Types are included.";
        ...
        private const string TemplateDataEmailNotificationActionPropertyTypeNotAssociated = "The property '{0}' that was defined as part of an <EmailNotificationAction> element is not associated with any Artifact Types defined in the Workflow.";
        ...
        private const string TemplateDataPropertyChangeActionPropertyTypeNotAssociated = "The property '{0}' that was defined as part of a <PropertyChangeAction> element is not associated with any Artifact Types defined in the Workflow.";
