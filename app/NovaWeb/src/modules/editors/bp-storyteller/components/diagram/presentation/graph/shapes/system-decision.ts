...
import {IDiagramNodeElement, IDecision, ISystemTask} from "../process-graph-interfaces";
...
export class SystemDecision extends UserTaskChildElement<IProcessShape> implements IDecision, IUserTaskChildElement {
    ...
    public showMenu(mxGraph: MxGraph) {
        ...
        this.addOverlay(mxGraph, this, "/Areas/Web/Style/images/Storyteller/add-neutral.svg", this.MENU_SIZE, this.MENU_SIZE, "Add Branch", mxConstants.ALIGN_CENTER, mxConstants.ALIGN_BOTTOM, 0, 7, "hand");
