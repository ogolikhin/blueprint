...
import {ExecutionEnvironmentDetector} from './execution-environment-detector';

// See List of User Agent Strings - http://www.useragentstring.com/pages/useragentstring.php
describe("ExecutionEnvironmentDetector", () => {

    it("Browser info is defined", () => {
        // Arrange
    ...
    it("Mac OS X 10.10 - Firefox 33.0", () => {
        // Arrange
        var userAgent =
    ...
    it("Windows XP - Internet Explorer 8.0", () => {
        // Arrange
        var userAgent =
    ...
    it("Windows Vista - Internet Explorer 9.0", () => {
        // Arrange
        var userAgent =
    ...
    it("Windows 7 - Internet Explorer 8.0", () => {
        // Arrange
        var userAgent =
    ...
    it("Windows 7 - Internet Explorer 11.0", () => {
        // Arrange
        var userAgent =
    ...
    it("Windows 8.1 - Internet Explorer 11.0", () => {
        // Arrange
        var userAgent =
    ...
    it("Windows Phone - IE Mobile 9.0", () => {
        // Arrange
        var userAgent =
