...
describe("DiscardAction", () => {
    ...
    it("throws exception when localization is null", inject((statefulArtifactFactory: IStatefulArtifactFactory,
        ...
        // act
        try {
            new DiscardAction(artifact, localization, messageService, null, loadingOverlayService, null);
        } catch (exception) {
            error = exception;
        }
    ...
    it("is disabled when artifact is null", inject((localization: ILocalizationService,
        ...
        // act
        const discardAction = new DiscardAction(artifact, localization, messageService, null, loadingOverlayService, null);
