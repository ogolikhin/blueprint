...
INSERT INTO #tempAppLabels ([Key], [Locale], [Text]) VALUES ('Close_Project_UnpublishedArtifacts', 'en-US', N'You have saved but unpublished changes ({0}).<br/><br/>Consider publishing or discarding them before continuing.')
