...
namespace Model
{
    public interface ISvcShared : IDisposable
    {
        ...
        /// <param name="artifactsIds">The artifact(s)' IDs whose are to be discarded.</param>
        ...
        List<NovaPublishArtifactResult> PublishArtifacts(
            IUser user,
        ...
        IList<IArtifactBase> SearchArtifactsByName(
            IUser user,
