...
namespace AdminStore.Controllers
{
    ...
    public class InstanceController : LoggableApiController
    {
        ...
        /// </summary>
        /// <param name="id"></param>
        /// <param name="isViewProjectsPermissions"></param>
        /// <remarks>
        ...
        public async Task<List<InstanceItem>> GetInstanceFolderChildrenAsync(int id, bool isViewProjectsPermissions = false)
        {
            return await _instanceRepository.GetInstanceFolderChildrenAsync(id, Session.UserId, isViewProjectsPermissions);
        }
