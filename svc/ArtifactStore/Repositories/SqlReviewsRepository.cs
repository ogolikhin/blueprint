        ...
        public async Task<ReviewSummary> GetReviewSummary(int containerId, int userId)
        {
            ...
            var reviewSummary = new ReviewSummary()
            {
                ...
                ArtifactsStatus = new ReviewParticipantArtifactsStats
                {
                    ...
                    NotRequired = reviewDetails.ApprovalNotRequiredArtifactsCount + (reviewDetails.TotalArtifacts - reviewDetails.TotalViewable) // Not required includes artifacts with no permission
                },
                ReviewType = reviewType,
