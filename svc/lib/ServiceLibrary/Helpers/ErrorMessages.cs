namespace ServiceLibrary.Helpers
{
    public class ErrorMessages
    {
        ...
        public static class Collections
        {
            ...
            public static readonly string CollectionDoesNotHaveArtifactsCouldBeRemoved = "Collection (Id:{0}) does not have artifacts that could be removed.";
            public static readonly string AddArtifactsInvalidParameters = "Invalid parameters to add artifact(s)";
            public static readonly string RemoveArtifactsInvalidParameters = "Invalid parameters to remove artifact(s)";
