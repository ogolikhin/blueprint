...
module Storyteller {
    ...
    export class Button extends DiagramElement implements IOverlayHandler, IMouseEventHandler {
        ...
        public render(processGraph: ProcessGraph, parent: MxCell, x: number, y: number, style: string) {
            ...
            processGraph.graph.addCell(this, parent);

            this.updateOverlay(processGraph.graph);
        }
