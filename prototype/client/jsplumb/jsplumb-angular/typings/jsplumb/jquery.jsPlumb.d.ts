...
declare var jsPlumb: jsPlumbStatic;

interface jsPlumbStatic extends jsPlumbInstance {
...
interface jsPlumbInstance {
    ...
    addEndpoint(element: any, options?: any): any;
    ...
    draggable(el: JQuery, options?: DragOptions): jsPlumbInstance;
    ...
    detach(connection: Connection, params?: any): void;
    ...
    recalculateOffsets(el: Element): jsPlumbInstance;
...
interface SourceOptions {
    ...
    onMaxConnections(info: any, originalEvent: any): void;
}
