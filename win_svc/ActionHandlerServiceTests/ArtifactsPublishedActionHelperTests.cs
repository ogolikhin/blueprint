...
namespace ActionHandlerServiceTests
{
    ...
    {
        private readonly TenantInformation _tenantInformation;
        private readonly Task<List<SqlArtifactTriggers>> _triggers;
        private readonly Task<List<SqlWorkFlowStateInformation>> _states;
        private readonly List<NotificationAction> _notificationActions;

        public ArtifactsPublishedActionHelperTests()
        {
            ...
            _notificationActions = new List<NotificationAction> {new NotificationAction()};
        }
