...
namespace ArtifactStore.Controllers
{
    ...
    public class RelationshipsControllerTests
    {
        ...
        public async Task GetRelationships_ArtifactHasPermission_Success()
        {
            ...
            _artifactPermissionsRepositoryMock.Setup(m => m.GetArtifactPermissionsInChunks(It.IsAny<List<int>>(), _session.UserId, false, null)).ReturnsAsync(permisionDictionary);
