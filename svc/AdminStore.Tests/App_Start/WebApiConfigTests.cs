...
namespace AdminStore
{
    ...
    public class WebApiConfigTests
    {
        ...
        public void Register_Always_RegistersCorrectRoutes()
        {
            ...
            // Assert
            config.AssertTotalRoutes(55, "Please update asserts in WebApiConfigTests when changing routes.");
            ...
            config.AssertAction<InstanceController>("DeleteInstanceFolder", HttpMethod.Delete, "instance/folder/1");
            config.AssertAction<InstanceController>("UpdateInstanceFolder", HttpMethod.Put, "instance/folder/1");
        }
