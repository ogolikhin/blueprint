...
describe("Property Editor ->", () => {
    ...
    describe("Convert values", () => {
        ...
        it("convert - no field", () => {
            ...
            const newValue = editor.convertToModelValue(null, null);
            //Asserts
        ...
        it("convert - invalid value", () => {
            ...
            const newValue = editor.convertToModelValue({data: descriptor}, undefined);
            //Asserts
            expect(newValue).toBeNull();
        });
        it("text", () => {
            ...
            model.name = "NewValue";
            const newValue = editor.convertToModelValue({data: descriptor}, null);
            //Asserts
        ...
        it("richtext", () => {
            ...
            //act
            const oldValue = editor.getModelValue(descriptor.fieldPropertyName);
            const newValue = editor.convertToModelValue({data: descriptor}, "<div>TEST</div>");
            //Asserts
            expect(newValue).not.toEqual(oldValue);
        ...
        it("richtext (no inner text)", () => {
            ...
            //act
            const oldValue = editor.getModelValue(descriptor.fieldPropertyName);
            const newValue = editor.convertToModelValue({data: descriptor}, "<div></div>");
            //Asserts
