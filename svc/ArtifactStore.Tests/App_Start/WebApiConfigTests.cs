...
namespace ArtifactStore
{
    ...
    public class WebApiConfigTests
    {
        ...
        public void Register_Always_RegistersCorrectRoutes()
        {
            ...
            // Assert
            config.AssertTotalRoutes(46, "Please update asserts in WebApiConfigTests when changing routes.");
            ...
            config.AssertAction<ArtifactController>("GetStandardArtifactTypes", HttpMethod.Get, "artifacts/standardartifacttypes?isRegularArtifactTypes=false");
