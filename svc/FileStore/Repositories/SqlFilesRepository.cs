...
namespace FileStore.Repositories
{
    public class SqlFilesRepository : IFilesRepository
    {
        ...
        public async Task UpdateFileHead(Guid fileId, long fileSize, int chunkCount)
        {
            ...
            await _connectionWrapper.ExecuteAsync("[FileStore].UpdateFileHead", prm, commandTimeout: _commandTimeout, commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task<FileChunk> GetFileChunk(Guid guid, int num)
        {
            ...
            return (await _connectionWrapper.QueryAsync<FileChunk>("[FileStore].ReadFileChunk", prm, commandTimeout: _commandTimeout, commandType: CommandType.StoredProcedure)).FirstOrDefault();
        }
        ...
        public async Task<int> DeleteFileChunk(Guid guid, int chunkNumber)
        {
            ...
            return (await _connectionWrapper.ExecuteScalarAsync<int>("[FileStore].DeleteFileChunk", prm, commandTimeout: _commandTimeout, commandType: CommandType.StoredProcedure));
        }
        ...
        public async Task<int> MakeFilePermanent(Guid guid)
        {
            var prm = new DynamicParameters();
            prm.Add("@FileId", guid);
            return (await _connectionWrapper.ExecuteScalarAsync<int>("[FileStore].MakeFilePermanent", prm, commandTimeout: _commandTimeout, commandType: CommandType.StoredProcedure));
        }
        ...
        public File GetFileInfo(Guid fileId)
        {
            ...
            return _connectionWrapper.Query<File>("[FileStore].ReadFileHead", prm, commandTimeout: _commandTimeout, commandType: CommandType.StoredProcedure).FirstOrDefault();
        }
