...
namespace HtmlLibrary
{
    ...
    {
        private const string MENTION_LINK_OBJECT_NAME = "LinkAssemblyQualifiedName";
        private const string MENTION_LINK_OBJECT = "RichTextMentionLink";
        private const string MENTION_EMAIL_ATTRIBUTE = "Email";
