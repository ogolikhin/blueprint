...
{
    public class GenerateUserStoriesMessageHandler : IHandleMessages<GenerateUserStoriesMessage>
    {
        public Task Handle(GenerateUserStoriesMessage message, IMessageHandlerContext context)
        {
            try
            {
