...
namespace ArtifactStoreTests
{
    ...
    public class CopyArtifactTests : TestBase
    {
        ...
        */
        ...
        [TestRail(191225)]
        [Description("Create & publish an artifacts.  Copy an artifact with call that does not have token in a header .  Verify response returns code 401 Unauthorized.")]
        public void CopyArtifact_PublishedArtifact_CopyWithNoTokenInAHeader_401Unauthorized(BaseArtifactType artifactType)
        {
            ...
            }, "'POST {0}' should return 400 Bad Request once called with no token in a header!", SVC_PATH);
