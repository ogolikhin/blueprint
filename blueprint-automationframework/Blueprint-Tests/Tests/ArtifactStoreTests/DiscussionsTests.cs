...
namespace ArtifactStoreTests
{
    ...
    public class DiscussionsTests : TestBase
    {
        ...
        public void GetDiscussions_PublishedArtifact_ReturnsCorrectDiscussion()
        {
            ...
            ArtifactStoreHelper.AssertIndicatorFlags(Helper, viewerUser, artifact.Id, (int)ItemIndicatorFlags.HasComments);
        }
        ...
        public void GetDiscussions_MarkedForDeleteArtifact_ValidateReturnedDiscussion()
        {
            ...
            ArtifactStoreHelper.AssertIndicatorFlags(Helper, _adminUser, artifact.Id, (int)ItemIndicatorFlags.HasComments);
        }
        ...
        public void GetDiscussions_PublishedSubArtifact_ReturnsCorrectDiscussion()
        {
            ...
            ArtifactStoreHelper.AssertIndicatorFlags(Helper, _adminUser, artifact.Id, (int)ItemIndicatorFlags.HasComments, postedComment.ItemId);
        }
        ...
        public void UpdateDiscussion_PublishedArtifact_ReturnsUpdatedDiscussion()
        {
            ...
            ArtifactStoreHelper.AssertIndicatorFlags(Helper, _adminUser, artifact.Id, (int)ItemIndicatorFlags.None);
        }
        ...
        public void UpdateDiscussion_PublishedSubArtifact_ReturnsUpdatedDiscussion()
        {
            // Setup:
            var artifact = Helper.CreateAndPublishArtifact(_project, _adminUser, BaseArtifactType.Process);
            var postedComment = AddDiscussionToSubArtifactOfStorytellerProcess(artifact, _authorUser);
            ...
            Assert.DoesNotThrow(() =>
            {
                updatedDiscussion = OpenApiArtifact.UpdateRaptorDiscussion(Helper.BlueprintServer.Address,
                    userTask.Id, postedComment, comment, _authorUser);
            }, "UpdateDiscussions shouldn't throw any error.");
        ...
        public void UpdateDiscussion_CloseAndReopenDiscussion_SuccessfullyUpdated()
        {
            // Setup:
            var artifact = Helper.CreateAndPublishArtifact(_project, _adminUser, BaseArtifactType.UseCase);
            var discussion = artifact.PostRaptorDiscussion(ORIGINAL_COMMENT, _authorUser);
