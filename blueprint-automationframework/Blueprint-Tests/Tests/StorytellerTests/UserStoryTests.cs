...
namespace StorytellerTests
{
    public class UserStoryTests
    {
        ...
        public void UserStoryGenerationProcessWithDefaultUserTask_NumberOfUserTasksAndGeneratedUserStoriesAreEqual()
        {
            ...
            var userTasksOnProcess = _process.GetProcessShapesByShapeType(ProcessShapeType.UserTask).Count;
        ...
        public void UserStoryGenerationProcessWithDefaultUserTask_VerifyingContents()
        {
            ...
            foreach (IProcessShape shape in _process.GetProcessShapesByShapeType(ProcessShapeType.UserTask))
            {
